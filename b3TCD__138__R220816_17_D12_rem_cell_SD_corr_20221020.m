...
mouseID = char('b3TCD__138__');%フォルダ名, データ保存名, https://jp.mathworks.com/help/matlab/ref/char.html
dinfo = char('R220816_17_D12_');%フォルダ名
anltype = char('Rem_cell_SD_dFcorr_');
...
Data_imp = b3TCD138007vtimeTomsortmcor2;%rename (manual, copy and paste from workspace)
Data_raw = Data_imp(3:end,2:end);%remove time and Tom+/-

% 2-2. the number of frames in each sessoin (Manual)
Day0_frame = 0;
Day1pre_frame = 11999;
Day1context_frame = 11999;
Day1after_frame = 0;
Day1post_frame = 11800;
Day2pre_frame = 12000;
Day2context_frame = 11999;
Day2after_frame = 0;
Day2post_frame = 12000;
...
TPfP_Cell = 44; TPfP_first = 1+TP_last; TPfP_last = TPfP_Cell + TP_last;
...
%% 3. cellular activity (SD, each sesion, All=TP+TPfP+TN), Day1
 ...
 % set parameter
    ...
    mkdir('3_cellularSD') % フォルダの作成
    cd ('3_cellularSD');%今作成したフォルダに移動
    ...
    SDbinaryData_D1pre = sdData_D1pre>SD_thres;%binarize, 3SD以上を1, それ未満を0に。https://jp.mathworks.com/help/matlab/matlab_prog/find-array-elements-that-meet-a-condition.html?searchHighlight=%E6%9D%A1%E4%BB%B6&s_tid=srchtitle_%25E6%259D%25A1%25E4%25BB%25B6_1
    %D1ctx. all
    ...
    SDbinaryData_D1ctx = sdData_D1ctx>SD_thres;%binarize, 3SD以上を1, それ未満を0に。https://jp.mathworks.com/help/matlab/matlab_prog/find-array-elements-that-meet-a-condition.html?searchHighlight=%E6%9D%A1%E4%BB%B6&s_tid=srchtitle_%25E6%259D%25A1%25E4%25BB%25B6_1
    %D1after. all
    ...
    SDbinaryData_D1after = sdData_D1after>SD_thres;%binarize, 3SD以上を1, それ未満を0に。https://jp.mathworks.com/help/matlab/matlab_prog/find-array-elements-that-meet-a-condition.html?searchHighlight=%E6%9D%A1%E4%BB%B6&s_tid=srchtitle_%25E6%259D%25A1%25E4%25BB%25B6_1
    %D1post. all    
    ...
    SDbinaryData_D1post = sdData_D1post>SD_thres;%binarize, 3SD以上を1, それ未満を0に。s://jp.mathworks.com/help/matlab/matlab_prog/find-array-elements-that-meet-a-condition.html?searchHighlight=%E6%9D%A1%E4%BB%B6&s_tid=srchtitle_%25E6%259D%25A1%25E4%25BB%25B6_1
...
%         SDbinaryData_Time = [Data_imp(503:end,1),SDbinaryData_D1ctx];%add time
        ...
        d_content = char('3SDbinar_raster_');
...
%         saveas(gcf, [mouseID,session,celltype,d_content,dtime], 'tif');
    ...
    All_D1pre_Cell_Totalactive = sum(SDbinaryData_D1pre, 1);%各細胞の活動量 (3SD以上のframe数)
...
%     cd ('3_cellular activity_SD');%今作成したフォルダに移動
    ...
    SDbinaryData_D2pre = sdData_D2pre>SD_thres;%binarize, 3SD以上を1, それ未満を0に。https://jp.mathworks.com/help/matlab/matlab_prog/find-array-elements-that-meet-a-condition.html?searchHighlight=%E6%9D%A1%E4%BB%B6&s_tid=srchtitle_%25E6%259D%25A1%25E4%25BB%25B6_1
    %D2ctx. all
    ...
    SDbinaryData_D2ctx = sdData_D2ctx>SD_thres;%binarize, 3SD以上を1, それ未満を0に。https://jp.mathworks.com/help/matlab/matlab_prog/find-array-elements-that-meet-a-condition.html?searchHighlight=%E6%9D%A1%E4%BB%B6&s_tid=srchtitle_%25E6%259D%25A1%25E4%25BB%25B6_1
    %D2after. all
    ...
    SDbinaryData_D2after = sdData_D2after>SD_thres;%binarize, 3SD以上を1, それ未満を0に。https://jp.mathworks.com/help/matlab/matlab_prog/find-array-elements-that-meet-a-condition.html?searchHighlight=%E6%9D%A1%E4%BB%B6&s_tid=srchtitle_%25E6%259D%25A1%25E4%25BB%25B6_1
    %D2post. all    
    ...
    SDbinaryData_D2post = sdData_D2post>SD_thres;%binarize, 3SD以上を1, それ未満を0に。s://jp.mathworks.com/help/matlab/matlab_prog/find-array-elements-that-meet-a-condition.html?searchHighlight=%E6%9D%A1%E4%BB%B6&s_tid=srchtitle_%25E6%259D%25A1%25E4%25BB%25B6_1
...
%         title('Day2 context')
    ...
    All_D2pre_Cell_Totalactive = sum(SDbinaryData_D2pre, 1);%各細胞の活動量 (3SD以上のframe数)
    %         All_Cell_Totalactive_Mean = mean(All_Cell_Totalactive);%全細胞の平均活動量
...
%この解析は、synchronous activityの補助的なもの
    mkdir('4_synchronousSD') % フォルダの作成
    cd ('4_synchronousSD');%今作成したフォルダに移動
...
cd ..;%上のフォルダに移動
    ...
    %% 5. correlation (All, for TP_all vs TN all), Day1
...
% threshold
    ...
    SDbinaryData_TNrand_D1pre = sdData_TNrand_D1pre>SD_thres;%3SD以上を1, それ未満を0に。https://jp.mathworks.com/help/matlab/matlab_prog/find-array-elements-that-meet-a-condition.html?searchHighlight=%E6%9D%A1%E4%BB%B6&s_tid=srchtitle_%25E6%259D%25A1%25E4%25BB%25B6_1
    ...
    TNrand_D1pre_Cell_Totalactive = sum(SDbinaryData_TNrand_D1pre, 1);%各細胞の活動量 (3SD以上のframe数)
...
% threshold
    ...
    SDbinaryData_TNrand_D1ctx = sdData_TNrand_D1ctx>SD_thres;%3SD以上を1, それ未満を0に。https://jp.mathworks.com/help/matlab/matlab_prog/find-array-elements-that-meet-a-condition.html?searchHighlight=%E6%9D%A1%E4%BB%B6&s_tid=srchtitle_%25E6%259D%25A1%25E4%25BB%25B6_1
    ...
    TNrand_D1ctx_Cell_Totalactive = sum(SDbinaryData_TNrand_D1ctx, 1);%各細胞の活動量 (3SD以上のframe数)
...
%     SDbinaryData_TNrand_D1after = sdData_TNrand_D1after>SD_thres;%3SD以上を1, それ未満を0に。https://jp.mathworks.com/help/matlab/matlab_prog/find-array-elements-that-meet-a-condition.html?searchHighlight=%E6%9D%A1%E4%BB%B6&s_tid=srchtitle_%25E6%259D%25A1%25E4%25BB%25B6_1
% 
%     % results from binarized df matrix
...
%     TNrand_D1after_Cell_Totalactive = sum(SDbinaryData_TNrand_D1after, 1);%各細胞の活動量 (3SD以上のframe数)
...
% threshold
    ...
    SDbinaryData_TNrand_D1post = sdData_TNrand_D1post>SD_thres;%3SD以上を1, それ未満を0に。https://jp.mathworks.com/help/matlab/matlab_prog/find-array-elements-that-meet-a-condition.html?searchHighlight=%E6%9D%A1%E4%BB%B6&s_tid=srchtitle_%25E6%259D%25A1%25E4%25BB%25B6_1
    ...
    TNrand_D1post_Cell_Totalactive = sum(SDbinaryData_TNrand_D1post, 1);%各細胞の活動量 (3SD以上のframe数)
...
% threshold
    ...
    SDbinaryData_TNrand_D2pre = sdData_TNrand_D2pre>SD_thres;%3SD以上を1, それ未満を0に。https://jp.mathworks.com/help/matlab/matlab_prog/find-array-elements-that-meet-a-condition.html?searchHighlight=%E6%9D%A1%E4%BB%B6&s_tid=srchtitle_%25E6%259D%25A1%25E4%25BB%25B6_1
    ...
    TNrand_D2pre_Cell_Totalactive = sum(SDbinaryData_TNrand_D2pre, 1);%各細胞の活動量 (3SD以上のframe数)
...
% threshold
    ...
    SDbinaryData_TNrand_D2ctx = sdData_TNrand_D2ctx>SD_thres;%3SD以上を1, それ未満を0に。https://jp.mathworks.com/help/matlab/matlab_prog/find-array-elements-that-meet-a-condition.html?searchHighlight=%E6%9D%A1%E4%BB%B6&s_tid=srchtitle_%25E6%259D%25A1%25E4%25BB%25B6_1
    ...
    TNrand_D2ctx_Cell_Totalactive = sum(SDbinaryData_TNrand_D2ctx, 1);%各細胞の活動量 (3SD以上のframe数)
...
%     SDbinaryData_TNrand_D2after = sdData_TNrand_D2after>SD_thres;%3SD以上を1, それ未満を0に。https://jp.mathworks.com/help/matlab/matlab_prog/find-array-elements-that-meet-a-condition.html?searchHighlight=%E6%9D%A1%E4%BB%B6&s_tid=srchtitle_%25E6%259D%25A1%25E4%25BB%25B6_1
% 
%     % results from binarized df matrix
...
%     TNrand_D2after_Cell_Totalactive = sum(SDbinaryData_TNrand_D2after, 1);%各細胞の活動量 (3SD以上のframe数)
...
% threshold
    ...
    SDbinaryData_TNrand_D2post = sdData_TNrand_D2post>SD_thres;%3SD以上を1, それ未満を0に。https://jp.mathworks.com/help/matlab/matlab_prog/find-array-elements-that-meet-a-condition.html?searchHighlight=%E6%9D%A1%E4%BB%B6&s_tid=srchtitle_%25E6%259D%25A1%25E4%25BB%25B6_1
    ...
    TNrand_D2post_Cell_Totalactive = sum(SDbinaryData_TNrand_D2post, 1);%各細胞の活動量 (3SD以上のframe数)
